...
class RationaleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Tokenize rationales
        rationale_token = []
        for r in self.rationales[idx]:
            r_tokenized = self.tokenizer.tokenize(r)
            rationale_token.append(r_tokenized)
        ...
        rationale_mask = self.create_rationale_mask(rationale_token, input_ids)
